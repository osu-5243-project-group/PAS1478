...
def classifyBodiesTopicsPlaces():
   topic_data,topic_labels=get_data('reduced_data/reduced_bodies.out','reduced_data/topics_labels.out')
   ...
   places_data,places_labels=get_data('reduced_data/bodies.out','reduced_data/places_labels.out')
...
def main():
	...
	# call classify bodies function in main to classiffy the bodies
	classifyBodiesTopicsPlaces()
	classifyTopicsTitles()
	classifyPlacesDatelines()
